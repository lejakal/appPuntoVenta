...
import com.example.danielreyes.TAT.views.AdapterListadoClientes;
...
public class ListadoClientesActivity extends AppCompatActivity {
    ...
    AdapterListadoClientes adapter;
    TextView campoId;
    ...
    private OnNavigationItemSelectedListener mOnNavigationItemSelectedListener = new OnNavigationItemSelectedListener() {
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ListadoClientesActivity.this.getSupportFragmentManager().beginTransaction();
            ListadoClientesActivity.this.getSupportFragmentManager().beginTransaction();
            switch (menuItem.getItemId()) {
                case R.id.nav_home /*2131296427*/:
                    ListadoClientesActivity.this.startActivity(new Intent(ListadoClientesActivity.this.getApplicationContext(), PedidosActivity.class));
                    break;
                case R.id.navigation_albums /*2131296429*/:
                    return true;
                case R.id.navigation_dashboard /*2131296430*/:
                    ListadoClientesActivity.this.startActivity(new Intent(ListadoClientesActivity.this.getApplicationContext(), ListInventoryActivity.class));
                    break;
                case R.id.navigation_notifications /*2131296432*/:
                    ListadoClientesActivity.this.startActivity(new Intent(ListadoClientesActivity.this.getApplicationContext(), ZonasActivity.class));
                    break;
                case R.id.navigation_songs /*2131296433*/:
                    ListadoClientesActivity.this.startActivity(new Intent(ListadoClientesActivity.this.getApplicationContext(), SynPedidosActivity.class));
                    break;
            }
            return false;
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_listado_clientes);
        ...
        this.adapter = new AdapterListadoClientes(this, this.clientes);
        listClientes(this.iduserLogeado, string);
        TextView textView = this.campoNombre;
        ...
        this.sv.setOnQueryTextListener(new OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String str) {
                ListadoClientesActivity.this.getClientes(str, ListadoClientesActivity.this.iduserLogeado, string);
                return false;
            }
        });
            ...
            asyncHttpClient.post("http://shared12.co-prueba.site/~ospostco/curso/checkpeople.php", new AsyncHttpResponseHandler() {
                    ...
                    if (i == 200) {
                        try {
                            ...
                            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                                ...
                                ListadoClientesActivity.this.controller.insertPeople(hashMap);
                            }
                            Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "Sincronizacion de people exitosa!", 1).show();
                        } catch (JSONException e) {
                            Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "error en la sincronizacion de people!", 1).show();
                            e.printStackTrace();
                        }
                    }
                }
                ...
                public void onFailure(int i, Header[] headerArr, byte[] bArr, Throwable th) {
                    if (i == HttpStatus.SC_NOT_FOUND) {
                        Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "Requested resource not found", 1).show();
                    } else if (i == HttpStatus.SC_INTERNAL_SERVER_ERROR) {
                        Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "Something went wrong at server end", 1).show();
                    } else {
                        Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "Unexpected Error occcured! [Most common Error: Device might not be connected to Internet]", 1).show();
                    }
                }
            });
        } else {
                    ...
                    if (i == 200) {
                        try {
                            ...
                            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                                ...
                                ListadoClientesActivity.this.controller.insertCustomer(hashMap);
                            }
                        } catch (JSONException e) {
                            Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "error en la sincronizacion de Customer!", 1).show();
                            e.printStackTrace();
                        }
                    }
                }
                    ...
                    if (i == 200) {
                        try {
                            ...
                            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                                ...
                                ListadoClientesActivity.this.controller.insertZonas(hashMap);
                            }
                            Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "Sincronizacion de Zonas exitosa!", 1).show();
                            ListadoClientesActivity.this.finish();
                        } catch (JSONException e) {
                            Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "error en la sincronizacion de zonas!", 1).show();
                            e.printStackTrace();
                        }
                    }
                }
    ...
    public void syncdatosAsignaciones() {
        ...
        if (this.controller.getAllasignaciones().size() == 0) {
            ...
            asyncHttpClient.post("http://shared12.co-prueba.site/~ospostco/curso/checkasignaciones.php", new AsyncHttpResponseHandler() {
                    ...
                    if (i == 200) {
                        try {
                            ...
                            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                                ...
                                ListadoClientesActivity.this.controller.insertAsignaciones(hashMap);
                            }
                            Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "Sincronizacion de Asignaciones exitosa!", 1).show();
                            ListadoClientesActivity.this.finish();
                        } catch (JSONException e) {
                            Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "error en la sincronizacion de Asignaciones!", 1).show();
                            e.printStackTrace();
                        }
                    }
                }
                ...
                public void onFailure(int i, Header[] headerArr, byte[] bArr, Throwable th) {
                    ListadoClientesActivity.this.prgDialog.hide();
                    if (i == HttpStatus.SC_NOT_FOUND) {
                        Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "Requested resource not found", 1).show();
                    } else if (i == HttpStatus.SC_INTERNAL_SERVER_ERROR) {
                        Toast.makeText(ListadoClientesActivity.this.getApplicationContext(), "Something went wrong at server end", 1).show();
